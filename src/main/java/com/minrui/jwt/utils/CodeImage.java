...
public class CodeImage {
    ...
    public CodeImage(String code) {
        this.code = code;
        this.codeCount = code.length();
        creatImage();
    }

    public CodeImage(int width, int height, String code) {
        this.code = code;
        this.width = width;
        this.height = height;
        creatImage();
    ...
    public CodeImage(int width, int height, int codeCount, String code) {
        this.code = code;
        this.width = width;
        this.height = height;
    ...
    public CodeImage(int width, int height, int codeCount, int lineCount, String code) {
        this.code = code;
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
 ...
 /*public void getCode3(HttpServletRequest req, HttpServletResponse response,HttpSession session) throws IOException{
        // 设置响应的类型格式为图片格式
            ...
            session.setAttribute("imageCode", vCode.getImageCode());
